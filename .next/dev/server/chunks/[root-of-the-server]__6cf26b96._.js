...
async function GET(request) {
    try {
        ...
        if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute === "function") {
            ...
            // SQLite (Local)
            profile = __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("SELECT * FROM profile ORDER BY id DESC LIMIT 1").get();
        }
        if (!profile) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    try {
        ...
        const { Name, IMG_URL, birthday = null, From = null, Family = null, Job = null, hobby = null, password } = body;
        // 管理者認証
        ...
        `,
            ...
            // SQLite
            __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
          INSERT INTO profile 
          (Name, IMG_URL, birthday, "From", Family, Job, hobby) 
          VALUES (?, ?, ?, ?, ?, ?, ?)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6cf26b96._.js.map