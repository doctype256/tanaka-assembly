...
"[project]/projects/tanaka-assembly/app/api/comments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        try {
            ...
            if (all === "true") {
                ...
                if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$tanaka$2d$assembly$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute === "function") {
                    ...
                    // SQLite (Local)
                    comments = __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$tanaka$2d$assembly$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("SELECT id, article_title, name, message, approved, created_at FROM comments ORDER BY created_at DESC").all();
                }
            ...
            if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$tanaka$2d$assembly$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute === "function") {
                ...
                // SQLite (Local)
                comments = __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$tanaka$2d$assembly$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("SELECT id, article_title, name, message, created_at FROM comments WHERE article_title = ? AND approved = 1 ORDER BY created_at DESC").all(article_title);
            }
            return res.status(200).json(comments);
        } catch (err) {
    ...
    if (req.method === "POST") {
        try {
            ...
            if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$tanaka$2d$assembly$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute === "function") {
                ...
                // SQLite (Local)
                __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$tanaka$2d$assembly$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("INSERT INTO comments (article_title, name, message) VALUES (?, ?, ?)").run(article_title, name, message);
            }
    ...
    if (req.method === "PATCH") {
        try {
            ...
            if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$tanaka$2d$assembly$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute === "function") {
                ...
                // SQLite (Local)
                __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$tanaka$2d$assembly$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("UPDATE comments SET approved = ? WHERE id = ?").run(approved ? 1 : 0, id);
            }
    ...
    if (req.method === "DELETE") {
        try {
            ...
            if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$tanaka$2d$assembly$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute === "function") {
                ...
                // SQLite (Local)
                __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$tanaka$2d$assembly$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("DELETE FROM comments WHERE id = ?").run(id);
            }
            return res.status(200).json({
                success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c04eb8d3._.js.map