...
const resetButtonStyle: React.CSSProperties = { background: 'none', border: 'none', color: '#e53e3e', cursor: 'pointer', fontSize: '14px', textDecoration: 'underline', marginBottom: '10px',fontSize: '16px' };